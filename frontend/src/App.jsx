        ...
        <div style={{ position: 'relative', display: 'flex', gap: 8, marginBottom: 18 }}>
          <div style={{ flex: 1, position: 'relative' }}>
            ...
            >
              ...
              <kbd style={{ padding: '2px 7px', fontSize: 10, fontFamily: 'var(--font-mono)', background: 'rgba(0,212,255,0.1)', color: 'var(--accent)', border: '1px solid rgba(0,212,255,0.2)', borderRadius: 3, letterSpacing: '0.04em', flexShrink: 0 }}>⌘K</kbd>
            </button>
          </div>
          <button onClick={analyze} disabled={loading} className="btn-brand" style={{ height: 42, padding: '0 22px' }}>
            {loading ? '⟳' : 'Analyze ▶'}
          </button>
        </div>
